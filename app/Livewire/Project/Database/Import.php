...
class Import extends Component
{
    ...
    public string $mariadbRestoreCommand = 'mariadb -u $MYSQL_USER -p$MYSQL_PASSWORD $MYSQL_DATABASE';
...
EOD;
                    ...
                    $this->mariadbRestoreCommand = 'mariadb -u $MYSQL_USER -p$MYSQL_PASSWORD $MYSQL_DATABASE';
                }
                break;
