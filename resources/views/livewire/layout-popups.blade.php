<div x-data="{
    ...
    @endauth
    @if (instanceSettings()->is_sponsorship_popup_enabled && !isCloud() && ! auth()->user()?->isClient())
    ...
    @endif
    @if (!currentTeam()->isAnyNotificationEnabled() && (auth()->user()?->isAdmin() || auth()->user()?->isOwner()))
