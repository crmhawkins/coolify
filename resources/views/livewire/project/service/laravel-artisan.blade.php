            ...
            @else
                ...
                <div class="w-full">
                    ...
                    <div class="flex items-start w-full gap-2">
                        {{-- Enter-in-input dispatches $wire.run() directly.
                             The pre-execution confirm dialog was removed
                             at operator request — the Artisan Commands
                             panel is already gated behind the service's
                             update capability, so the extra confirmation
                             was friction for power users who run migrate
                             / optimize:clear / cache:clear multiple
                             times per session. --}}
